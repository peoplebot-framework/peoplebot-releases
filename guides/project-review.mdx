...
**Release:** 0.1.0a4. **Runtime:** Windows execution/admission path. This release makes no live CLI/model acceptance claim for the adapter.
...
[Review contract](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/contracts/project-review-v0.md), [Adapter configuration](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/peoplebot/adapters/project_review/adapter.json), [Offline example](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/examples/project_review_fake.py).
