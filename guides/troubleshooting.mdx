...
The 0.1.0a4 adapters check specific CLI versions and protocols. Confirm the configured and installed versions agree. A protocol failure is not evidence of a Windows scheduling failure.
...
[State errors](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/peoplebot/state.py), [Context errors](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/contracts/context-assembly-v0.md), [Execution provenance](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/contracts/execution-provenance-v0.md).
