...
**Release:** 0.1.0a4. **Model calls:** none. This is a Python API, not a separate CLI command.
...
commit = "<public-distribution-commit>"
...
[Context assembly contract](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/contracts/context-assembly-v0.md), [Context preparation contract](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/docs/contracts/context-preparation-v0.md).
