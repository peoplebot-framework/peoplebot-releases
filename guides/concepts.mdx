...
**The public 0.1.0a4 package implements bounded Git message publication and reading.** Message content never grants repository access or task authority. See [coordination and finite work](/guides/coordination).
...
For the original technical definitions, see the public [framework overview](https://github.com/peoplebot-framework/peoplebot-releases/blob/v0.1.0a4/README.package.md).
